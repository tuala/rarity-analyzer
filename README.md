...
Before you generate your rarity site, get your collection metadata (ERC-721 format) ready in one JSON array, [like so](./data/collection), then fill in a few configuration values by copying our [Sample ENV](./env.sample) to ./env.production. Read below for detailled steps.
