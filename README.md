...
Before you generate your rarity site, Ready your collection data (ERC-721 format) in [one JSON array], then fill in a few configuration values by copying our [Sample ENV](./env.sample).
