			...
			<div className="flex items-center justify-between w-full max-w-screen-xl mx-auto space-x-4">
						...
						<a className="flex items-center">
							...
							{!process.env.NEXT_PUBLIC_COLLECTION_LOGO && (
								<span className="sm:inline-block hidden text-lg font-semibold dark:text-gray-200">
									...
									<small class="text-md">{process.env.NEXT_COLLECTION_NAME}</small>
								</span>
							)}
						</a>
					</Link>
				...
				<div className="text-sm flex-shrink-0">
					<div className="flex items-center justify-center space-x-1">
						...
						<a
							className=" hidden lg:block inline-flex justify-center items-center px-4 py-2 rounded-md bg-amber-400 text-white font-medium transition-all hover:bg-amber-200 dark:hover:bg-amber-200 ease-in-out duration-200"
